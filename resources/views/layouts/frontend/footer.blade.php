...
{{--                    <a class="footer-logo" href="#" title="Logo"><img alt="logo" src="{{asset('frontend/user-end/images/logo.png')}}">{{config('app.name')}}<span>Education of Best</span></a>--}}
{{--                    <ul>--}}
...
{{--                    <ul>--}}
{{--                        <li><a href="#" title="Flickr"><img src="{{asset('frontend/user-end/images/flickr1.jpg')}}" alt="flickr1" width="85" height="83"/></a></li>--}}
{{--                        <li><a href="#" title="Flickr"><img src="{{asset('frontend/user-end/images/flickr2.jpg')}}" alt="flickr2" width="85" height="83"/></a></li>--}}
{{--                        <li><a href="#" title="Flickr"><img src="{{asset('frontend/user-end/images/flickr3.jpg')}}" alt="flickr3" width="85" height="83"/></a></li>--}}
{{--                        <li><a href="#" title="Flickr"><img src="{{asset('frontend/user-end/images/flickr4.jpg')}}" alt="flickr4" width="85" height="83"/></a></li>--}}
{{--                        <li><a href="#" title="Flickr"><img src="{{asset('frontend/user-end/images/flickr5.jpg')}}" alt="flickr5" width="85" height="83"/></a></li>--}}
{{--                        <li><a href="#" title="Flickr"><img src="{{asset('frontend/user-end/images/flickr6.jpg')}}" alt="flickr6" width="85" height="83"/></a></li>--}}
{{--                    </ul>--}}
{{--                </aside>--}}
{{--            </div>--}}
{{--        </div>--}}
