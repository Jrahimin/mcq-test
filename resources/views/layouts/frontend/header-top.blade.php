    ...
    <div class="top-header container-fluid no-padding">
        <div class="container">
            <div class="topheader-left">
                ...
                <a href="mailto:admin@a2bpublications.com" title="admin@a2bpublications.com"><i class="fa fa-envelope-o" aria-hidden="true"></i>Emailus: admin@a2bpublications.com</a>
            </div>
