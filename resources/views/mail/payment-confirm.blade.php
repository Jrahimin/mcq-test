            ...
            <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td style="{{ $style['email-body'] }}" width="100%"><table style="{{ $style['body_action'] }}" width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                                <td>Hello <b>{{ $user->name }}</b>,
                                    <p>Your payment of BDT {{ $paymentInfo->amount }} has been Received. Thank you.</p>
                                </td>
                            </tr>
                        </table></td>
                </tr>
                    ...
                    <td><table style="{{ $style['email-footer'] }}" align="center" width="570" cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="{{ $fontFamily }} {{ $style['email-footer_cell'] }}">
                                    <p style="{{ $style['paragraph-sub'] }}"> &copy; {{ date('Y') }} <a style="{{ $style['anchor'] }}" href="{{ secure_url('/') }}" target="_blank">{{ config('app.name') }}</a>.
                                        All rights reserved.
                                    </p>
                                </td>
                            </tr>
